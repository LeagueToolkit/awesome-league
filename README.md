...
- [Aventurine-League-Tools](https://github.com/RitoShark/Aventurine-League-Tools) - Blender plugin for League of Legends asset import/export
...
- [Chroma-Tool-Studio](https://github.com/VISION4RIO/chroma-tool-studio) - Tool that allows editing .DDS files using full color instead of pixels, and recoloring VFX in one click by tracking relevant values in code
